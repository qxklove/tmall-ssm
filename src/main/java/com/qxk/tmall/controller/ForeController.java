...
import com.qxk.tmall.pojo.*;
import com.qxk.tmall.service.*;
import comparator.*;
...
//        oid="+order.getId() +"&
    ...
    public String payed(Integer oid, float total, Model model,HttpSession session) {
        if (oid!=null){
